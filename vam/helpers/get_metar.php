...
<?php
	...
	{
		$url ="http://10.89.65.173:8080/FSDserver/IVAO/metar.txt/19Z7?station_ids=".$location."&std_trans=translated&chk_metars=on&hoursStr=past+1+hours&chk_tafs=on&submitmet=Submit";
		$fileName = $url;
		$metar = '';
