			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo ABOUT; ?>
					...
					<ul class="dropdown-menu">
						...
						<li><a href="./foro/index.php"><?php echo FORUM; ?></a></li>
...
<div class="container-fluid">
	...
	<div class="text-center center-block">
		<p class="txt-railway"><a href="https://virtualairlinesmanager.net">Powered by Virtual Airlines Manager</a></p>
		...
		<br />
		<br />
		<a href="https://virtualairlinesmanager.net" target="_blank"><img src="images/logo_vam.png" /></a>
	</div>
</div>
<br/>
</body>
