...
$sql_map = "select DISTINCT plane_type,ias,flight_id,u.gvauser_id as gvauser_id,u.callsign as callsign,u.name as name,gs,altitude,surname,departure,arrival,latitude,longitude,flight_status,heading,perc_completed,
...
$sql_map = "select DISTINCT r.flight as flightnum,plane_type,ias,flight_id,u.gvauser_id as gvauser_id,u.callsign as callsign,u.name as name, gs,altitude,surname,lf.departure, lf.arrival,lf.latitude,lf.longitude,lf.flight_status,lf.heading,lf.perc_completed,
pending_nm, a1.latitude_deg as dep_lat, a1.longitude_deg as dep_lon , a2.latitude_deg as arr_lat, a2.longitude_deg as arr_lon , network
...
<div style="margin-top:15px;"><i class="fa fa-plane fa-fw"></i></div>
            ...
            <a href="./index.php?page=fleet_public" class="small-box-footer">More informations <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
<div style="margin-top:15px;"><i class="fa fa-globe fa-fw"></i></div>
            ...
            <a href="./index.php?page=route_public" class="small-box-footer">More informations <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
<div style="margin-top:15px;"><i class="fa fa-suitcase fa-fw"></i></div>
            ...
            <a href="./index.php?page=stats" class="small-box-footer">More informations <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
<div style="margin-top:15px;"><i class="ion ion-person"></i></div>
            ...
            <a href="./index.php?page=pilots_public" class="small-box-footer">More informations <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
        <?php
            ...
            $sql = "SELECT DISTINCT flight_id FROM `vam_live_flights` WHERE UNIX_TIMESTAMP (now())-UNIX_TIMESTAMP (last_update)>180";
            if (!$result = $db->query($sql)) {
                die('There was an error running the query [' . $db->error . ']');
            }
            while ($row = $result->fetch_assoc())
...
?></ul></div>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary direct-chat direct-chat-primary">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title"><?php echo "Newest pilots"; ?></h3>

                  <div class="box-tools pull-right">
                    <?php
                      if ($num_pilots <= '8'){    ?>                    
                        <span class="label label-danger"><?php echo $num_pilots; ?> new pilots</span>
                     <?php } else {     ?>                   
                ...
                <div class="box-body no-padding">
                        <?php
                            ...
                            $sql = "select DISTINCT gvauser_id, pilot_image, concat(name) as pilot , DATE_FORMAT(register_date,'$va_date_format') as register_date from gvausers where activation=1 order by DATE_FORMAT(register_date,'%Y%m%d') desc limit 8";
                            if (!$result = $db->query($sql)) {
                                die('There was an error running the query [' . $db->error . ']');
                            }
                        ?>
                ...
                <div class="box-footer text-center">
                  <a href="./index.php?page=pilots_public" class="uppercase">View All Pilots</a>
                </div>
                <!-- /.box-footer -->
              </div>
              <!--/.box -->
          ...
          <div class="box box-primary direct-chat direct-chat-primary">
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><?php echo "Latest flights"; ?></h3>
            ...
            <div class="panel-body">
						<?php
							...
							$sql = "select DISTINCT gvauser_id,a1.name as dep_name, a2.name as arr_name, a1.iso_country as dep_country,a2.iso_country as arr_country,
...
<span class="info-box-icon"><div style="margin-top:20px;"><i class="fa fa-exchange fa-fw"></i></div></span>
            ...
            <div class="info-box-content">
              <span class="info-box-text"><?php echo "FLIGHTS REGULAR"; ?></span>
...
<span class="info-box-icon"><div style="margin-top:20px;"><i class="fa fa-clock-o fa-fw"></i></div></span>
            ...
            <div class="info-box-content">
              <span class="info-box-text"><?php echo "TOTAL HOURS"; ?></span>
...
<span class="info-box-icon"><div style="margin-top:20px;"><i class="fa fa-code-fork fa-fw"></i></div></span>
            ...
            <div class="info-box-content">
              <span class="info-box-text"><?php echo "FLIGHTS CHARTER"; ?></span>
...
<span class="info-box-icon"><div style="margin-top:20px;"><i class="fa fa-bar-chart fa-fw"></i></div></span>
          ...
          <div class="box box-primary direct-chat direct-chat-primary">
            <div class="box-header with-border">
              <i class="fa fa-map"></i>
              <h3 class="box-title"><?php echo "Events"; ?></h3>
            ...
            <!-- /.box-header -->
                <div class="box-body">
                  <?php
                      ...
                      $sql = "select DISTINCT event_id,event_name,DATE_FORMAT(publish_date,'$va_date_format') as publish_date_web ,DATE_FORMAT(publish_date,'%Y%m%d') as publish_date,DATE_FORMAT(hide_date,'%Y%m%d') as hide_date, DATE_FORMAT(now(),'%Y%m%d') as currdat
           ...
           <div class="col-md-6">
              <div class="box box-primary direct-chat direct-chat-primary">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">facebook page</h3>

                  <div class="box-tools pull-right">
                    <span data-toggle="tooltip" title="Seguidores" class="badge bg-yellow">SIGUEME!</span>
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
...
<center><div class="fb-page" data-href="https://www.facebook.com/aldo ginarte suarez" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/virtualairlinesmanager" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/aldo ginarte suarez">SalvAdri</a></blockquote></div></center>
...
<div class="col-md-6">
            ...
            <div class="panel-body">
						<a class="twitter-timeline" href="https://twitter.com/cacsaaviacion" data-width="800" data-height="490">Tweets by CACSA</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
						<script>!function (d, s, id) {
           ...
           <div class="col-md-12"> 
              <div class="box box-primary direct-chat direct-chat-primary">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Servidor de UTILES</h3>
                ...
                <!-- /.box-header -->
                <div class="box-body"><br>
                  <center><iframe src="http://10.89.65.173:8080/wordpress/" width="600" height="400" allowtransparency="true" frameborder="0"></iframe></center>
