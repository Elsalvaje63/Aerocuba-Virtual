	...
	<div class="panel-body">
		<div class="row">
			<div class="col-sm-4 col-sm-4">
				<div class="thumbnail">
					<a href="./index_vam_op.php?page=mails"><img src="images/Emailags.png"></a>
					<div class="caption">
			...
			<div class="col-sm-4 col-sm-4">
				<div class="thumbnail">
					<a href="./index_vam_op.php?page=route_selection_stage1"><img src="images/Airplane_G.png"></a>
					<div class="caption">
			...
			<div class="col-sm-4 col-sm-4">
				<div class="thumbnail">
					<a href="#" data-toggle="modal" data-target="#JumpModal"><img src="images/22map_115452.png"></a>
					<div class="caption">
		...
		<div class="row">
			<div class="col-sm-4 col-sm-4">
				<div class="thumbnail">
					<a href="./index_vam_op.php?page=my_bank"><img src="images/4288596analyticschartgrowthincreasingstocks-115760_115753.png"></a>
					<div class="caption">
			...
			<div class="col-sm-4 col-sm-4">
				<div class="thumbnail">
					<a href="./index_vam_op.php?page=pirep_manual_create"><img src="images/3700468-archive-document-education-exam-file-test_108747.png"></a>
					<div class="caption">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-4">
				<div class="thumbnail">
					<a href="./index_vam_op.php?page=vaparameters_info"><img src="images/networkserver_92603.PNG"></a>
					<div class="caption">
		...
		<div class="row">
			<div class="col-sm-4 col-sm-4">
				<div class="thumbnail">
					<a href="./index_vam_op.php?page=tours_pilot"><img src="images/travel-holiday-vacation-310_89073.png"></a>
					<div class="caption">
