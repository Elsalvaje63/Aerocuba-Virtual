				...
				<div class="panel-heading"><?php echo VAMACARS_VALIDATION_COMMENTS; ?></div>
					<div class="container">
				      <form id="validate_comment_form" name="validate_comment_form" method="post">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<span class="add-on"><i class="icon-pencil"></i></span>
									<textarea id="fskeepercomment" name="fskeepercomment" class="span4" rows="4" cols="80" placeholder="Comment (Max 200 characters)"></textarea>
						...
						<div class="control-group">
						  <div class="controls">
							<button id="fskeeperaddcommentbtn" name ="fskeeperaddcommentbtn" class="btn btn-primary"><?php echo VAMACARS_VALIDATION_ADD_COMMENT; ?></button>
							<button id="fskeeperacceptbtn" name ="fskeeperacceptbtn" class="btn btn-success"><?php echo VAMACARS_VALIDATION_ACCEPT; ?></button>
							<button id="fskeeperrejectbtn" name ="fskeeperrejectbtn" class="btn btn-warning"><?php echo VAMACARS_VALIDATION_REJECT; ?></button>
							  <button id="fskeeperdeletebtn" name ="fskeeperdeletebtn" class="btn btn-danger"><?php echo VAMACARS_VALIDATION_DELETE; ?></button>
					      </div>
						</div>
						<div class="control-group">
							<div id="result"></div>
