...
<meta name="description"
      content="VAM. New layout by Johnny"/>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="./index.php" class="logo">
      ...
      <span class="logo-lg"><b>V</b>AM</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <?php include('get_pilot_data.php'); 
          if (strlen ($pilot_image)<=10)
							{
...
<li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./index.php?page=rules"><i class="fa fa-file-text-o fa-fw"></i> Routes</a></li>
...
<li><a href="http://10.89.65.173:8080/VAM/vam/index.php" target="_blank"><i class="fa fa-circle-o text-red"></i> <span> Admin</span></a></li>    
      
<li><a href="http://10.89.65.173:8080/VAM/vam/index.php" target="_blank"><i class="fa fa-globe text-blue"></i> <span> VAM</span></a></li>
