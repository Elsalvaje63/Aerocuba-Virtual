...
<html lang="en">
<head>
<title>SALVADRI AIRLINE.  | El Salvaje.</title>
<meta charset="utf-8">
...
<meta name="description"
      content="VAM by Johnny"/>
<meta name="author" content="Alejandro Garcia, Jonatha Silva and Rafael Santos">
...
?>
  <header class="main-header">
    ...
    <a href="./index.php" class="logo">
      ...
      <span class="logo-mini"><b></b>VAM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Virtual</b> Airlines Manager</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="http://10.89.65.173:8080/foro/" target="_blank"><i class="fa fa-graduation-cap fa-fw"></i> Forum</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./index.php?page=route_public"><i class="fa fa-globe fa-fw"></i> Route</a></li>
...
<li>
          <a href="./index.php?page=pilots_public">
            <i class="fa fa-users fa-fw"></i> <span> Pilot Roster</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-red"><?php echo $num_pilots; ?></small>
            </span>
          </a>
        </li>
        <li>
          <a href="./index.php?page=stats">
            <i class="fa fa-area-chart fa-fw"></i> <span> Statistics</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <li class="bg-green">					
          <a href="./index.php?page=school" style="background-color: rgb(0, 166, 90);">
            <i class="fa fa-user-plus" style="color: rgb(255, 255, 255);"></i> <span style="color: rgb(255, 255, 255);"> Join us</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-blue">Open</small>
            </span>
          </a>
        </li>
        <li><a href="#"><i class="fa fa-whatsapp"></i> <span> Whatsapp group</span>
					</a></li>
      
<li class="header">POWERED BY</li>
<li><a href="https://www.rafaelsantos.es" target="_blank"><i class="fa fa-plane text-yellow"></i><span>Rafael Santos</span></a></li>   
<li><a href="https://edsilo.com" target="_blank"><img src="images/EDSILO BRANCO.png" alt="User Image"  WIDTH="18" HEIGHT="15" BORDER=0 ALT="20"><span>  Edsilo</span></a></li>    
...
<li><a href="#examiner_johnny" role="button" data-toggle="modal" rel="tooltip" data-original-title='Hello'><i class="fa fa-coffee text-green"></i> <span> Jonatha Silva</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
...
<?php
    ...
    <a href="./index.php" class="logo">
      ...
      <span class="logo-mini"><b></b>VAM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Virtual</b> SALVADRI AIRLINE</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
...
<li>
        ...
        <li class="bg-green">
          <a href="./index_vam_op.php?page=route_selection_stage1" style="background-color: rgb(0, 166, 90);">
            <i class="fa fa-plane fa-fw" style="color: rgb(255, 255, 255);"></i><span style="color: rgb(255, 255, 255);">Book a flight</span>
            <span class="treeview">
            </span>
          </a>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="./index.php?page=staff"><i class="fa fa-user-o fa-fw"></i> Staff</a></li>
            <li><a href="./index.php?page=rules"><i class="fa fa-file-text-o fa-fw"></i> Rules</a></li>
            <li><a href="https://www.edsilo.com/en/virtual-airlines" target="_blank"><i class="fa fa-graduation-cap fa-fw"></i> forum</a></li>
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
            <i class="fa fa-gears fa-fw"></i>
            <span>Pilot actions </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="./index_vam_op.php?page=mails"><i class="fa fa-envelope fa-fw"></i> Internal Mail</a></li>
            <li><a href="./index_vam_op.php?page=route_selection_stage1"><i class="fa fa-plane fa-fw"></i> Book route</a></li>
            <li><a href="#" data-toggle="modal" data-target="#JumpModal"><i class="fa fa-map-marker fa-fw"></i> Change location</a></li>
            <li><a href="./index_vam_op.php?page=my_bank"><i class="fa fa-money fa-fw"></i> My finances</a></li>
            <li><a href="./index_vam_op.php?page=pirep_manual_create"><i class="fa fa-hand-pointer-o fa-fw"></i> Manual pirep</a></li>
            <li><a href="./index_vam_op.php?page=my_profile"><i class="fa fa-edit fa-fw"></i> Edit profile</a></li>
            <li><a href="./index_vam_op.php?page=pilot_profile_stats&pilotid=<?php echo $_SESSION["id"];?>"><i class="fa fa-area-chart fa-fw"></i> My stats</a></li>
            <li><a href="./index_vam_op.php?page=vaparameters_info"><i class="fa fa-exclamation fa-fw"></i> VA parameters</a></li>
            <li><a href="./index_vam_op.php?page=download"><i class="fa fa-download fa-fw"></i> Downloads</a></li>
            <li><a href="./index_vam_op.php?page=tours_pilot"><i class="fa fa-external-link-square fa-fw"></i> Report tour leg</a></li>
          </ul>
        </li>
<li class="treeview">
          <a href="#">
...
<?php if ($_SESSION["access_administration_panel"] == 1) { ?>
				<li>
					<a href="../vamcore/Gvausers" target="_blank">
            <i class="glyphicon glyphicon-briefcase fa-fw"></i> <span> ADMIN Panel</span>
            <span class="pull-right-container">
            </span>
          </a>	
				<li>
				<a href="../vam/index.php?page=pilot_register">
            <i class="ion ion-person-add fa-fw"></i><span> New Pilot</span>
            <span class="pull-right-container">
						</span></a>
<?php } ?>
        <li class="header">LABELS</li>
...
<li class="header">POWERED BY</li>
<li><a href=""http://10.89.65.173:8080/VAM/vam/index.php" target="_blank"><img src="uploads/adrian.png"  alt="User Image"  WIDTH="18" HEIGHT="15" BORDER=0 ALT="20"><span>ALDO</span></a></li>   
<li><a href="http://10.89.65.173:8080/VAM/vam/index.php" target="_blank"><img src="uploads/adrian.png" alt="User Image"  WIDTH="18" HEIGHT="15" BORDER=0 ALT="20"><span>  Adrian Frometa</span></a></li>            
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         SALVADRI AIRLINE. !
        <small>Por los cielos de este Mundo.</small>
<div class="box-tools pull-right">               
	...
	<div class="modal-dialog">
      ...
      <h4 class="modal-title"><center><b>El Salvaje</b></center></h4><center>VAM Admin</center><br>
			<center><img src="images/mios.jpg" WIDTH="200" HEIGHT="200" BORDER=0 ALT="20" class="img-circle"></center>
			<h2><center><span class="label label-warning">El Salvaje</span></center></h2>
      </div>
      <div class="modal-body">
			<center><p>El Salvaje fundador <strong>VAM </strong> y <strong>Adrian</strong> Jefe de Operaciones.</p><p></p></center>
        <div class="modal-footer"><br>
		  <center><strong><i class="fa fa-envelope"></i> aldoginarte@gmail.com</strong></center>
...
<img src="./images/slider/slider3_pp.png" alt="...">
<div class="carousel-caption">
<h3>SALVADRI AIRLINE</h3>
          <p>contact: aldoginarte@gmail.com</p> 
</div>
</div>
<div class="item">
<img src="./images/slider/slider1_pp.png" alt="...">
<div class="carousel-caption">
<h3>SALVADRI AIRLINE</h3>
          <p>contact: aldoginarte@gmail.com</p> 
</div>
...
<div class="item">
<img src="./images/slider/slider2_pp.png" alt="...">
<div class="carousel-caption">
<h3>SALVADRI AIRLINE</h3>
          <p>contact: aldoginarte@gmail.com</p> 
</div>
...
<div class="item">
<img src="./images/slider/slide4_pp.png" alt="...">
<div class="carousel-caption">
<h3>SALVADRI AIRLINE</h3>
          <p>contact: aldoginarte@gmail.com</p> 
</div>
...
<div class="item">
<img src="./images/slider/slider5_pp.png" alt="...">
<div class="carousel-caption">
<h3>SALVADRI AIRLINE</h3>
          <p>contact: aldoginarte@gmail.com</p> 
</div>
